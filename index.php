                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <ul class="list-group list-group-flush border border-1 rounded">
                                    ...
                                    <span class="w-100" style="cursor:pointer" :class="{'done': task.done}" @click="invertDone(task)" >{{task.text}}</span>
                                    <i class="fa-solid fa-trash red" style="cursor:pointer" @click="deleteTask(index)"></i>
                                </li>
